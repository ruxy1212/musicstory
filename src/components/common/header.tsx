    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#0D0B1F]/80 backdrop-blur-2xl border-b border-white/5 shadow-[0_0_15px_rgba(99,102,241,0.2)] flex justify-between items-center w-full px-6 py-4">
        <div className="flex items-center gap-2">
          <Logo />
          <span className="text-xl md:text-2xl font-bold font-display italic bg-linear-to-r from-indigo-500 to-cyan-400 bg-clip-text text-transparent">
            MusicStory
          </span>
        </div>
        <div className="flex items-center gap-(--stack-lg)">
          <nav className="hidden md:flex gap-(--stack-md) font-medium">
