...
export default function NotFound() {
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-base relative overflow-hidden md:p-6 lg:p-8">
      ...
      {/* Card */}
      <div className="scanlines relative z-10 w-full max-w-lg rounded-2xl border border-[var(--border-hi)] bg-surface shadow-[0_24px_64px_rgba(0,0,0,0.6)] p-6 flex flex-col items-center gap-8 text-center animate-fade-up md:p-10">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center justify-center gap-3">
            ...
            <span className="font-mono text-[10px] tracking-[0.2em] uppercase text-warning">404</span>
          </div>
