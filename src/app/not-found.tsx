...
export default function NotFound() {
  return (
    <div className="min-h-screen flex items-center justify-center p-8 bg-[var(--bg-base)] relative overflow-hidden">
      ...
      {/* Card */}
      <div className="scanlines relative z-10 w-full max-w-lg rounded-2xl border border-[var(--border-hi)] bg-[var(--bg-surface)] shadow-[0_24px_64px_rgba(0,0,0,0.6)] p-10 flex flex-col items-center gap-8 text-center animate-fade-up">
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div className="w-28 h-28 rounded-full border border-[var(--border-hi)] flex items-center justify-center">
            {/* Inner ring */}
            <div className="w-20 h-20 rounded-full border border-[var(--primary)] bg-[var(--primary-dim)] shadow-[0_0_24px_var(--primary-glow)] flex items-center justify-center">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="text-[var(--primary)]">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center justify-center gap-3">
            ...
            <span className="font-mono text-[10px] tracking-[0.2em] uppercase text-[var(--accent)]">404</span>
          </div>
