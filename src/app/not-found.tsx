...
export default function NotFound() {
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-background relative overflow-hidden md:p-6 lg:p-8">
      ...
      {/* Card */}
      <div className="scanlines relative z-10 w-full max-w-lg rounded-2xl border border-(--border-hi) bg-surface shadow-[0_24px_64px_rgba(0,0,0,0.6)] p-6 flex flex-col items-center gap-8 text-center animate-fade-up md:p-10">
        {/* 404 glyph */}
        <div className="relative flex items-center justify-center">
          {/* Outer ring */}
          <div className="w-28 h-28 rounded-full border border-(--border-hi) flex items-center justify-center">
            {/* Inner ring */}
            <div className="w-20 h-20 rounded-full border border-error bg-primary-dim shadow-[0_0_24px_var(--primary-glow)] flex items-center justify-center">
              <svg
                width="32"
                height="32"
                viewBox="0 0 24 24"
          ...
          {/* Orbiting dot */}
          <span className="absolute top-1 right-1 w-2 h-2 rounded-full bg-accent shadow-[0_0_8px_var(--accent-glow)]" />
        </div>
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center justify-center gap-3">
            ...
            <span className="h-px w-8 bg-(--border-hi)" />
            <span className="font-mono text-[10px] tracking-[0.2em] uppercase text-warning">
              404
            </span>
          </div>
          <h1 className="font-['Syne'] text-3xl font-bold text-(--text-1) tracking-tight leading-tight">
            Page not found
          </h1>
        ...
        {/* Divider */}
        <div className="w-full h-px bg-linear-to-r from-transparent via-(--border-hi) to-transparent" />
