...
export const metadata: Metadata = {
  title: 'MusicStory',
  description:
    'Transform your audio tracks into cinematic visual journeys with AI-powered scene generation and professional video composition.',
  metadataBase: new URL('https://music-story.vercel.app'),
  openGraph: {
    title: 'MusicStory | AI Music Video Generator',
    description:
      'Transform your audio tracks into cinematic visual journeys with AI-powered scene generation.',
